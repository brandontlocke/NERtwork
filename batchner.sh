...
############################
#nertext=$(java -mx600m -cp ../stanford-ner-4.0.0/stanford-ner.jar edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ../stanford-ner-4.0.0/classifiers/english.all.3class.distsim.crf.ser.gz -textFile $file)
